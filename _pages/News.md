...
<div class="news-container">
    <div class="news-card">
        <div class="title">I made a UT Austin Beamer Template</div>
        <div class="description">You can access it through GitHub [https://github.com/debojjalb/UTAustinBeamer](https://github.com/debojjalb/UTAustinBeamer). I have tried to replicate the colors and logos as per the UT official design rules but my template is not official. Please crosscheck before using!</div>
    </div>
    <div class="news-card">
        <div class="title">I am learning to play the guitar and keyboard</div>
        <div class="description">
            ...
            <ul>
                <li>[Bosonto esge geche on Keyboard + Arranger](https://youtu.be/boWtt-A6qTU?si=vzbv0Mmv89o3w9Pc)</li>
                <li>[Purano shei diner kotha](https://youtu.be/uqbLpiiSf9M?si=j1hw4WHTiQ6bVB4t)</li>
                <li>[Pran chay chokhu na chay](https://youtu.be/M9QqOV-6YJo?si=dbRzfBskeRMM-rgm)</li>
            </ul>
        </div>
    </div>
    <div class="news-card">
    ...
    <div class="news-card">
        ...
        <div class="description">
            I presented our work on Electric Vehicle Last Mile Logistics. See my Research page for more details.
            <div class="image-group two-images">
                <div>
    ...
    <div class="news-card">
        <div class="title">I visited Canada as a part of MITACS Globalink Internship</div>
        <div class="description">
            <div class="image-group two-images">
                <div>
    ...
    <div class="news-card">
        <div class="title">Niagara Falls</div>
        <div class="description">
            <div class="image-group three-images">
                <div>
    ...
    <div class="news-card">
        <div class="title">The Telegraph School Awards</div>
        <div class="description">
    ...
    <div class="news-card">
        <div class="title">JBNSTS Award Ceremony</div>
        <div class="description">
            <div class="image-group one-image">
                <div>
